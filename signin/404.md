...
<html lang="en">
  <head>
    ...
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/fonts/themify/style.min.css">
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/fonts/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/vendors/animate/animate.min.css">
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/vendors/flipclock/flipclock.css">
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/vendors/swiper/css/swiper.min.css">
    <!-- END VENDOR CSS-->
    <!-- END CRYPTO CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/theme-assets/css/template-counter.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/assets/css/style.css">
    <!-- END Custom CSS-->


    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">

    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/css/util.css">
    <link rel="stylesheet" type="text/css" href="https://1dapp.github.io/Content/Front-theme/css/main.css">
...
$(document).ready(function () { 
        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = "https://turboshare.github.io/Home-Dashboard";
                }
                else {
  ...
  MyContract = new web3.eth.Contract(abi, address);
    ...
    <script src="https://1dapp.github.io/content/assets/js/socialjs.js"></script>
    <script>
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    <form class="w-100 validate-form" onsubmit="return false" id="signinform">
                        ...
                        <p class="m-b-15 text-right text-white">Dont have account ? <a href="https://turboshare.github.io/signup" class="text-white"> Sign up</a></p>
